...
# Use Redis adapter to run Action Cable in production (commented out if unused)
# gem "redis", ">= 4.0.1"

# Use Kredis for higher-level data types in Redis [https://github.com/rails/kredis]
# gem "kredis"
